...
setup(name='finite_elements',
      version = get_version(),
      description='A pure python finite elements solver with binding to import mesh from volmdlr',
      long_description=readme(),
      keywords='finite elements, FEM, FEA, CAD',
      url='https://github.com/Dessia-tech/finite_elements',
      ...
      install_requires=['packaging', 'dessia_common>=0.3.7', 'volmdlr', 'numpy', 'matplotlib'],
