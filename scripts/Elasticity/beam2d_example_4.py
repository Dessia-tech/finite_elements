...
node_loads = []
element_loads = [fe.loads.ElementsLoad(elements = [mesh_fe.elements_groups[2].elements[5]],
                                       value = load,
                                       dimension = 2)]
...
for index in [0, 1]:
    element_boundary_conditions.extend([
        finite_elements.conditions.ElementBoundaryCondition(mesh_fe.elements_groups[0].elements[index], 0, 1),
        finite_elements.conditions.ElementBoundaryCondition(mesh_fe.elements_groups[0].elements[index], 0, 2)])
...
analysis = fe.analysis.FiniteElementAnalysis(mesh = mesh_fe,
                                             ...
                                             element_boundary_conditions = element_boundary_conditions,
